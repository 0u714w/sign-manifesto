  ...
  return (
    <main className="flex flex-col items-center min-h-screen p-4 pt-8 md:pt-24 justify-start md:justify-center">
      <div className="text-center space-y-4 w-full md:max-w-3xl">
        <h1 className="text-3xl md:text-5xl font-videocond font-bold mb-2 md:mb-4 text-black">SIGN THE MANIFESTO</h1>
        <p className="mx-auto md:max-w-3xl text-lg md:text-2xl mb-1 px-6 md:px-0 text-black">
        ...
        <div className="flex flex-col items-center">
          <button
            ...
            className="border-2 border-black rounded-full px-3 md:px-5 py-1 md:py-2 font-videocond text-lg md:text-2xl hover:bg-black hover:text-white transition mt-4 cursor-pointer bg-white text-black"
          >
            SIGN FOR FREE
          </button>
          {authenticated && (
            <button
              onClick={logout}
              className="mt-2 text-black underline text-sm md:text-base font-videocond font-light hover:text-gray-700 cursor-pointer"
              type="button"
            >
              Logout
            </button>
